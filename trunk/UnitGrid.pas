...
uses
  ...
  NxCustomGrid, NxGrid, ExtCtrls, Options, ComCtrls, Menus, XPMan, StdCtrls, BF2ServerInfo, Unit1, StrUtils;
...
uses MUnit;
    ...
    begin
      ...
      //   NG.AddRow();
         ...
         NG.Cell[C_PING,     NG.RowCount-1].AsInteger:= 1000;
         NG.Cells[C_SERVER,  NG.RowCount-1]:= '^Unavaiable ...';
     ...
     //  NG.AddRow();
       ...
       NG.Cell[C_PING,    NG.RowCount-1].AsInteger:= 0;
    ...
    begin
      ...
      begin
       ...
       NG.Cell[H_ITEMID,  NG.RowCount-1].AsInteger:= Item.Index;
       NG.Cell[5,         NG.RowCount-1].AsInteger:= isMate(item.BF2Player[i].Name); //FriendlyName(item.BF2Player[i].Name);
                   {  }
       // NG.RowVisible[RowIndex] := Form1.SetRowVisibility(Item);
      end;
    ...
    begin
     ...
     if NG.cell[C_PING, i].AsInteger <> 1000  then Inc(Result);
    end;
    ...
    begin
              for i:=0 to NG.RowCount-1 do  begin
               ...
               begin
                 NG.Cell[C_PING, i].AsInteger := item.Ping;//PingVal;
      ...
      for i:=0 to Ng.RowCount-1 do
       ...
       begin
        ...
        // NG.AddRow();
         ...
         NG.Cell[C_PING,     i].AsInteger:= 1000;
         NG.Cells[C_SERVER,  i]:= '^Unavaiable ...';
