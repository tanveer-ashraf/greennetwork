...
interface
 uses
  ...
  OverbyteIcsWSocket, OverbyteIcsWndControl, OverbyteIcsWSocketS, OverbyteIcsPing, OverbyteIcsIcmp, ALfcnString, ALStringList;
...
{$I defs.inc}
 ...
 TBF2ServerInfo = class
  private
  protected
     FParamList         : TALStringList; //TALAVLStringList; //TStrings;
...
begin
  Inherited Create;
     ...
     FParamList :=  TALStringList.Create; //TStringList.Create;
            ...
            begin
              ...
              case Stage of
               0..44: begin
                        ...
                        begin
                           Str:= Str + Chr(B[i]);
                           Val:= ALPos(sigNames[STAGE], Str) > 0;
                           if Val then
                           begin
                             Str:= '';
                             Inc(i,2);
